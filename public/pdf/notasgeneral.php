...
$registros=mysqli_query($conexion,"SELECT * FROM users WHERE id='$iduser'") or
...
$pdf->Cell(60,6, 'Docente:'.$docente,0,1,'c',0);

$materia=mysqli_query($conexion,"SELECT * FROM materias WHERE id_user='$iduser'") or
  die("Problemas en el select:".mysqli_error($conexion));
